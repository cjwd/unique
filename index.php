...
if ($blogstyle == 'half') {
	...
	else { $width=620; $height=240; if ($bloglentitle == '') $bloglentitle = '56'; if ($bloglenexcerpt == '') $bloglenexcerpt = '44'; }
}
...
<div id="sub-main" class="<?php if ($themestyle != 'block') echo 'container_12'; ?>">
	...
	<div id="content" class="<?php
		...
		<?php if (($wp_query->max_num_pages > 1) && ($blogpaginationonoff!='false')) {
			if (function_exists('pagination')) pagination(); else paginate_links();
		} ?>
	</div>
	<!-- end of #content -->
